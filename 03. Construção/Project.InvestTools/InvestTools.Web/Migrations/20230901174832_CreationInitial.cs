    ...
    public partial class CreationInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    contaAplicacaoId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    nrBanco = table.Column<string>(type: "VARCHAR(4)", maxLength: 4, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contaAplicacao", x => x.contaAplicacaoId);
                    table.ForeignKey(
                        name: "FK_contaAplicacao_Investidor_InvestidorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_contaAplicacao_InvestidorId",
